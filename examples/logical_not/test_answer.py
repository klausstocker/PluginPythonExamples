"""Tests für die logische Verknüpfung mit not."""
...
class Checker(unittest.TestCase):  # do not rename; plugin checks expect this name
    def test_neither_limit_reached(self):
        self.assertIs(answer.pruefe_messwerte(42, 6.5), True)
    ...
    def test_both_limits_exceeded(self):
        self.assertIs(answer.pruefe_messwerte(75, 12.5), False)
    ...
    def test_both_exactly_at_limits(self):
        self.assertIs(answer.pruefe_messwerte(60, 10), False)

    def test_both_just_below_limits(self):
        self.assertIs(answer.pruefe_messwerte(59.9, 9.9), True)
